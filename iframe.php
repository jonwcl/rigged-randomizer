...
<script type="text/javascript">
  ...
  <script type="text/javascript">
    ...
    rdoIframeTracker._trackPageview("/widgets/integers/iframe.php?title=True+Random+Number+Generator&amp;buttontxt=Generate&amp;width=160&amp;height=200&amp;border=on&amp;bgcolor=%23FFFFFF&amp;txtcolor=%23777777&amp;altbgcolor=%23CCCCFF&amp;alttxtcolor=%23000000&amp;defaultmin=1&amp;defaultmax=100&amp;fixed=off");
  </script>
...
function myFunction() {
	if(counter == 0) {
		document.getElementById("true-random-integer-generator-result").innerHTML = 41;
		counter++;
	}
    else if(counter == 1) {
		document.getElementById("true-random-integer-generator-result").innerHTML = 5;
		counter++;
	}
	else if(counter == 2) {
		document.getElementById("true-random-integer-generator-result").innerHTML = 24;
		counter++;
	}
	else if(counter == 3) {
		document.getElementById("true-random-integer-generator-result").innerHTML = 86;
		counter++;
	}
	else if(counter == 4) {
		document.getElementById("true-random-integer-generator-result").innerHTML = 62;
		counter++;
	}
	else if(counter > 4) {
		document.getElementById("true-random-integer-generator-result").innerHTML = 54;
		counter = 0;
	}
}
</script>
...
<div id="true-random-integer-generator">
	...
	<span id="true-random-integer-generator-max-button-span">
		<input type="button" value="Generate" name="true-random-integer-generator-button" id="true-random-integer-generator-button" onclick="myFunction()" />
	</span>
